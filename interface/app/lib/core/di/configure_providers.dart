...
import 'package:app/data/repository/pokemon_repository_impl.dart';
...
class ConfigureProviders {
  ...
  static Future<ConfigureProviders> createDependencyTree() async {
    ...
    final movies_repository = PokemonRepositoryImpl(
    ...
    return ConfigureProviders(providers: [
      ...
      Provider<PokemonRepositoryImpl>.value(value: movies_repository),
    ]);
  }
}
